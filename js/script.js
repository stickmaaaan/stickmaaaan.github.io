...
const jobTitles = {
    en: ["IT System Electronics Engineer."], /*"Embedded Systems Developer", "Network Specialist"],*/
    de: ["IT-Systemelektroniker."], /*"Embedded Systems Entwickler", "Netzwerk Spezialist"]*/
};
